...
output "internet-gateway-id" {
  ...
  value       = try(aws_internet_gateway.igw[*].id, "no internet gateway")
}
...
output "public-route-table-id" {
  ...
  value       = try(aws_route_table.public_rt[0].id, "no public route table")
}
...
output "private-route-table-id" {
  ...
  value       = try(aws_route_table.private_rt[0].id, "no private route table")
}
